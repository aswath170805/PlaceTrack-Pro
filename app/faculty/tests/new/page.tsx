      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="bg-white rounded-3xl border border-slate-200 p-8 shadow-sm space-y-8">
          ...
          <form onSubmit={handleCreateTest} className="space-y-8">
            ...
            {/* AI Proctoring & Permitted Coding Languages */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="p-4 bg-amber-50/70 rounded-2xl border border-amber-200 flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-amber-700">Detect gaze, tab switches, and auto-submit on 3 flags</p>
                  </div>
                </div>
                <input
                  type="checkbox"
              ...
              <div className="p-4 bg-slate-50 rounded-2xl border border-slate-200 space-y-2">
                <label className="block text-xs font-bold text-slate-800">Permitted Programming Languages</label>
                <div className="flex items-center space-x-3 text-xs font-semibold text-slate-700 pt-1">
                  <span className="px-2 py-1 bg-white border border-slate-200 rounded-lg text-indigo-600 font-mono font-bold">C</span>
                  <span className="px-2 py-1 bg-white border border-slate-200 rounded-lg text-indigo-600 font-mono font-bold">C++</span>
                  <span className="px-2 py-1 bg-white border border-slate-200 rounded-lg text-indigo-600 font-mono font-bold">Java</span>
                  <span className="px-2 py-1 bg-white border border-slate-200 rounded-lg text-indigo-600 font-mono font-bold">Python</span>
                </div>
                <p className="text-[10px] text-slate-400">Students will be able to select from C, C++, Java, or Python in the code editor dropdown.</p>
              </div>
            </div>
