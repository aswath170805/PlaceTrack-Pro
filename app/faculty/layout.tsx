    ...
    return (
      <div className="min-h-screen bg-slate-950 text-white flex items-center justify-center p-6 text-center">
        <div className="bg-slate-900 border border-slate-800 rounded-3xl p-8 max-w-md w-full space-y-4 shadow-2xl">
          ...
          <h2 className="text-xl font-black text-white">Access Restricted to Verified Faculty</h2>
          <p className="text-xs text-slate-400">
            This hub is exclusively reserved for Teachers & Faculty members with verified <strong>@svce.ac.in</strong> credentials.
          </p>
          <Link href="/login" className="block py-3 bg-indigo-600 hover:bg-indigo-500 font-bold text-xs rounded-xl shadow-lg">
